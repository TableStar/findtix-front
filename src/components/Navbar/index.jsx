    ...
    return (
        ...
        w-screen h-[50px] md:h-[70px] border-b-[1px] gap-4 text-sm md:text-base px-2 md:px-8 font-medium sticky top-0 z-10" >
            ...
            <div className="flex flex-row items-center w-[50%] gap-2 md:gap-4">
                <p className="font-bold text-base md:text-2xl">Find<span className="font-black text-[#d2633b]">TIX</span></p>
                <input className="bg-gray-100 w-[80%] max-w-[360px] overflow-hidden py-1 px-1 border rounded-[20px]" type="text" placeholder="Search" />
            </div>
            ...
            <div className="navbar-btn flex flex-row justify-between items-center w-[50%]">
                ...
                <div className="hidden md:inline-block relative cursor-pointer p-0" style={{ backgroundColor: helpVisible ? "#f4f2f8" : "" }}>
                    ...
                    <div className="help-content absolute bg-white w-[250px] text-base font-normal mt-1 left-0" style={{ display: helpVisible ? "block" : "none" }}>
                        <div>Help Center</div>
                ...
                <div className="md:hidden flex cursor-pointer">
                    <button><AiOutlineMenu fontSize={"20px"} /></button>
                </div>
