...
const EventCards = (props) => {
    ...
    time = time[0] + ":" + time[1]
    return <div className="event-cards min-h-[370px] md:w-[300px] max-w-[400px] cursor-pointer" onClick={props.onClick}>
        <div className="relative h-[40%]">
            <img className="w-[100%] h-[100%] object-fill relative" src={props.src} />
            <button className="absolute flex justify-center items-center h-[40px] w-[40px] md:h-[50px] md:w-[50px] border rounded-full bg-white top-[185px] md:top-[165px] right-[55px] md:right-[70px]"><BiHeart className="text-[20px] md:text-[24px]" /></button>
            <button className="absolute flex justify-center items-center h-[40px] w-[40px] md:h-[50px] md:w-[50px] border rounded-full bg-white top-[185px] md:top-[165px] right-[10px]"><BiShareAlt className="text-[20px] md:text-[24px]" /></button>
        </div>
        <div className="flex flex-col justify-between h-[60%] gap-4 px-4 py-6">
            ...
            <div className="flex flex-col gap-1 text-sm font-[450]">
                <p>By <span className="text-base font-semibold text-blue-700">{props.username}</span></p>
